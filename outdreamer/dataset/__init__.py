...
from outdreamer.dataset.t2v_datasets import T2V_dataset
from outdreamer.dataset.transform import ToTensorVideo, TemporalRandomCrop, RandomHorizontalFlipVideo, CenterCropResizeVideo, LongSideResizeVideo, SpatialStrideCropVideo, CenterCropVideo
...
def getdataset(args):
    ...
    if args.dataset == 't2v':
        ...
        # resize = [CenterCropVideo((args.max_height, args.max_width)), ]
...
if __name__ == "__main__":
    ...
    from outdreamer.dataset.t2v_datasets import dataset_prog
    import random
