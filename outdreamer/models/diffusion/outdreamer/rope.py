...
try:
    ...
    from outdreamer.acceleration.parallel_states import get_sequence_parallel_state
except:
    torch_npu = None
    npu_config = None
    from outdreamer.utils.parallel_states import get_sequence_parallel_state
