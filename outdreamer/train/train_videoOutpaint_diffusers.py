        ...
        with torch.no_grad():
            ...
            for name, module in model.named_modules():
                if name.endswith("attn1"):
                    ...
                    module.processor.set_scale(args.attention_scale)
            ...
            c, t, h, w = x_given.shape[1], x_given.shape[2], x_given.shape[3], x_given.shape[4]
            input_mask = F.interpolate(input_mask, size=(t, h, w), mode='trilinear', align_corners=False).to(x_given.dtype)
